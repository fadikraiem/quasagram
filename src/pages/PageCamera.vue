  ...
  <q-page class="constrain-more q-pa-md">
   ...
   <div class="text-center q-pa-md">
     <q-btn v-if="hasCameraSupport" @click="captureImage" round color="grey-10" icon="eva-camera" size="lg" />
         <q-file v-else v-model="imageUpload" @input="captureImageFallback" label="Choose an image" accept="image/*" outlined>
   ...
   <div class="row justify-center q-ma-md">
    <q-input v-model="post.location" class="col col-sm-6" label="Location" dense >
       <template v-slot:append>
          <q-btn @click="getLocation" dense flat icon="eva-navigation-2-outline" />
        </template>
    </q-input>
     </div>
...
getCityAndCountry(position){
  let apiUrl = 'https://geocode.xyz/${poition.coords.latitude},${poition.coords.longitude}?json=1'
